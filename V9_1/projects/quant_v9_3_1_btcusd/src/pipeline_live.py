        ...
        try:
            ...
            if hasattr(self, 'audit_log') and self.audit_log:
                self.audit_log.write_loop_audit(
                    ...
                    adx14_h4=getattr(self, 'last_row', {}).get("adx14_h4"),
                    atr14_m1=getattr(self, 'last_row', {}).get("atr14_m1"),
                    atr14_h1=getattr(self, 'last_row', {}).get("atr14_h1"),
                    atr14_h4=getattr(self, 'last_row', {}).get("atr14_h4"),
                    atr_ratio=getattr(self, 'last_row', {}).get("atr_ratio"),
                    regime=decision.regime if decision is not None else None,
                    session_state=getattr(self, 'last_row', {}).get("session_flag"),
