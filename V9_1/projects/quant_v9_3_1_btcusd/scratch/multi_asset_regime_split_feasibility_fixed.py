#!/usr/bin/env python3
"""Multi‑Asset Regime‑Split Feasibility Audit (fixed version)

Generates a markdown report at `reports/multi_asset_regime_split_feasibility.md`.
"""
...
for asset in ASSETS:
    ...
    if improvement >= 1.5:
        ...
        tier = "C"
    report_lines.append(f"| {asset.upper()} | {cur_trades_wk:.2f} | {sim_trades_wk:.2f} | {improvement:.2f} | {tier} |\n")

report_lines.append("\n## Recommendations\n\n")
report_lines.append("**Tier A** – Strong candidate for regime‑split (≥ 1.5× improvement).\n\n")
report_lines.append("**Tier B** – Optional; modest gain (≈ 1.0–1.5×).\n\n")
